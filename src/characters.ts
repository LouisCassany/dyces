...
type Ability = {
    name: string;
    levels: { requirement: [number, string][]; effect: string }[];
};
...
export const characters: Character[] = [
        ...
        abilities: [
            {
                name: "Savage Strikes",
                levels: [
                    { requirement: [[3, "1-3"]], effect: "Deal 5 dmg" },
                    { requirement: [[4, "1-3"]], effect: "Deal 8 dmg" },
                    { requirement: [[5, "1-3"]], effect: "Deal 12 dmg" },
                ],
            },
            {
    ...
    },
    {
        ...
        passive: "Necrotic Aura: Whenever take damage, deal 1 dmg to attacker",
    },
    {
        name: "Ranger",
        health: 23,
