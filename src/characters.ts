...
export const characters: Character[] = [
    {
        ...
        abilities: {
            ...
            defense: { req: "5 in {4,6}", effect: "Battle Cry: Heal 5 HP + gain 1 CP" },
        ...
        passive: "Unstoppable: When Barbarian drops below 10 HP, gain +2 CP at the start of your turn",
        customCP: "Reckless Fury: Deal 2 dmg to target + take 1 dmg"
    },
    {
        name: "Paladin",
        health: 28,
        ...
        abilities: {
            ...
            defense: { req: "5 in {4,5}", effect: "Holy Light: Heal 3 HP + Remove 1 negative effect + gain 1 CP" },
        ...
        customCP: "Blessing: Heal 2 HP OR remove 1 negative effect"
    },
    {
        name: "Arcanist",
        health: 22,
        ...
        abilities: {
            ...
            defense: { req: "5 in {4,5}", effect: "Mana Infusion: Heal 5 HP + gain 1 CP" },
        ...
        passive: "Elemental Affinity: If you roll a double pair at any point, gain +1 CP immediately",
        customCP: "Arcane Surge: Reroll up to 2 dice on your current roll"
    },
    {
        name: "Necromancer",
        health: 24,
        ...
        abilities: {
            ...
            defense: { req: "5 in {4,5}", effect: "Dark Revival: heal 3 HP and steal 1CP" },
        ...
        customCP: "Necrotic Aura: if you have a negative effect, steal 2 HP"
    },
    {
        name: "Ranger",
        health: 23,
        ...
        abilities: {
            ...
            defense: { req: "5 in {4,6}", effect: "Camouflage: Evasive, Shield and gain 1 CP" },
        ...
        customCP: "Deal 3 dmg that ignores Shield"
    },
];
